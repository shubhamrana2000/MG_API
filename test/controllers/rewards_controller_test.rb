...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { coins_req: @reward.coins_req, trans_logo: @reward.trans_logo, trans_type: @reward.trans_type } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { coins_req: @reward.coins_req, trans_logo: @reward.trans_logo, trans_type: @reward.trans_type } }
